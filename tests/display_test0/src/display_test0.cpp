...
#include <display_test0_rtac_optix/ptx_files.h>
...
int main()
{
    ...
    auto ptxFiles = display_test0_rtac_optix::get_ptx_files();
    ...
    //CudaVector<uchar3> renderData(W*H); // Not needed (direct rendering to GL buffer)
